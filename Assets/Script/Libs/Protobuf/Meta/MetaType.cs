    ...
    public class MetaType : ISerializerProxy
    {
            ...
            if (isEnum)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        UnityEngine.Debug.Log("fieldNumber Convert.ToInt32 Error");
                    }
#endif
                    if (attrib != null)
                    {
        ...
        private ValueMember ApplyDefaultBehaviour(bool isEnum, ProtoMemberAttribute normalizedAttribute)
        {
            ...
            if (vm != null)
            {
				...
				vm.IsMap = ignoreListHandling ? false : vm.ResolveMapTypes(out dictionaryType, out keyType, out valueType);
